...
//	//verify response body
	public static void verifyResponseBody(String key, String expValue) {
		...
		log("pass",
				"Response Body is as expected , actual response body value is " + actualValue + "for the Key " + key);
	}
	...
	public static void verifyResponseHeaders(String key, String expValue) {
		...
		Assert.assertEquals(actualValue, expValue);
		log("pass", "Response Headers are as expected , actual response header value is " + actualValue + "for the Key "
				+ key);
	}
